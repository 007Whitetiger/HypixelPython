import requests
from HyPy.main import random_api_key, success, hypixel_url, uuid_url
from HyPy.errors import GuildNotFound, NoArguments, PlayerCountNotFound, KeyNotFound, LeaderboardNotFound, \
