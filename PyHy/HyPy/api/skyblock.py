import requests
from HyPython.main import random_api_key, hypixel_url, success
from HyPython.errors import BazaarNotFound, AucitionNotFound, NoArguments, ProfileNotFound, NewsNotFound
