import requests
from HyPython.errors import (PlayerNotFound, NoArguments, GuildNotFound, FriendsNotFound, PlayerCountNotFound,
                             RecentGamesNotFound)
from HyPython.main import success, hypixel_url, uuid_url, username_url, random_api_key
